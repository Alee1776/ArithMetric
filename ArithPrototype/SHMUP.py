...
def gameOver(): #Ram
    ...
    draw_text(screen,"Press any key to try again", 20, WIDTH / 2, HEIGHT / 2)  #Jenn
    ...
    while waiting:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYUP:   #Jenn
                waiting = False  
...
background = pygame.image.load(path.join(img_dir, "background.jpg")).convert() #Jenn
background_rect = background.get_rect()
player_img = pygame.image.load(path.join(img_dir, "playerShip1_orange.png")).convert()
player_mini_img = pygame.transform.scale(player_img, (25, 19))
player_mini_img.set_colorkey(BLACK)
bullet_img = pygame.image.load(path.join(img_dir, "pencil.jpg")).convert() #Jenn
meteor_images = []
